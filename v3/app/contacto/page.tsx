...
export default function ContactoPage() {
  return (
    <section className="mx-auto max-w-6xl px-6 pt-20 md:pt-28 pb-20 grid gap-14 md:grid-cols-[1fr_1.1fr]">
      <div>
        <p className="text-[11px] font-600 tracking-[0.28em] uppercase text-gold-ink mb-6">Contacto</p>
        ...
        <ul className="mt-8 space-y-2.5 text-sm text-void/60">
          <li className="flex items-start gap-2.5"><span className="text-gold-ink shrink-0">✓</span> Respondemos en el día laborable</li>
          <li className="flex items-start gap-2.5"><span className="text-gold-ink shrink-0">✓</span> Hablas con el equipo que construye la plataforma</li>
          <li className="flex items-start gap-2.5"><span className="text-gold-ink shrink-0">✓</span> Si VELIA no encaja con tu despacho, te lo decimos</li>
        </ul>
      </div>
      <ContactForm />
    </section>
